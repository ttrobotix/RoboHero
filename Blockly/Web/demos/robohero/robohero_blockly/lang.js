...
Code.init = function() {
  ...
  */
  ...
  console.log("@@ has change all msg for js, MSG.length=" + MSG.length ) ;
...
Code.initLanguage = function() {
  ...
  */
    for (var lang in Code.LANGUAGE_NAME) {
	    var option = new Option(Code.LANGUAGE_NAME[lang], lang);
		if (lang == Code.LANG) {
		  option.selected = true;
		}
		languageMenu.options.add(option);
...
document.write('<script src="../code/msg/' + Code.LANG + '.js"></script>\n');
